...
class ConversationClient:
    ...
    def generate_object(
        ...
        *,
        ...
        -------
        BotObjectResponse
            Response containing the generated object. The response will have a type of BotObjectResponse.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/conversations/{jsonable_encoder(conversation_id)}/generate_object",
            method="POST",
            json={
                "schema": schema,
                "conversationMessageId": convert_and_respect_annotation_metadata(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(
                    BotObjectResponse,
                    parse_obj_as(
                        type_=BotObjectResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
            if _response.status_code == 404:
