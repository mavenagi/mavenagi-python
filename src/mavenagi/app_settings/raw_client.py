        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=SearchAppSettingsResponse,  # type: ignore
...
class AsyncRawAppSettingsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def search(
        self, *, index: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SearchAppSettingsResponse]:
        """
        Search for app settings which have the `$index` key set to the provided value.
